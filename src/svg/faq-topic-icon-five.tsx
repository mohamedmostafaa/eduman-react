      ...
      >
        <g id="location-mark" transform="translate(-3.5 0.1)">
          <g
            ...
            transform="translate(21.696 54.707)"
          >
            <g
              id="Group_4180"
              data-name="Group 4180"
              transform="translate(4.301 1.213)"
            >
              <path
                id="Path_8348"
                data-name="Path 8348"
                d="M23.9,50.7H41.875V64.264H23.9Z"
                transform="translate(-23.9 -50.7)"
                fill="#c9d8ef"
              />
            </g>
            <g
          ...
          <g
            ...
            transform="translate(4.713 17.434)"
          >
            <path
              id="Path_8352"
              data-name="Path 8352"
          ...
          <g
            ...
            transform="translate(3.5 16.221)"
          >
            <path
              id="Path_8353"
              data-name="Path 8353"
          ...
          <g
            ...
            transform="translate(10.558 23.168)"
          >
            <path
              id="Path_8354"
              data-name="Path 8354"
              d="M9.9,21H58.642V49.231H9.9Z"
          ...
          <g
            ...
            transform="translate(9.345 21.955)"
          >
            <path
              id="Path_8355"
              data-name="Path 8355"
          ...
          <g
            ...
            transform="translate(18.939 1.113)"
          >
            <path
              id="Path_8356"
              data-name="Path 8356"
          ...
          <g
            ...
            transform="translate(25.004 2.657)"
          >
            <path
              id="Path_8357"
              data-name="Path 8357"
              ...
              transform="translate(-23 -2.4)"
              fill="#4fbd96"
            />
          </g>
          <g
            id="Group_4191"
            data-name="Group 4191"
            transform="translate(17.836 -0.1)"
          >
            <path
              id="Path_8358"
              data-name="Path 8358"
          ...
          <g
            ...
            transform="translate(23.129 5.083)"
          >
            <circle
              id="Ellipse_122"
              ...
              cy="10.587"
              r="10.587"
              transform="translate(1.213 1.213)"
              fill="#fff"
            />
            <path
              id="Path_8359"
...
export default FaqTopicIconFive;
