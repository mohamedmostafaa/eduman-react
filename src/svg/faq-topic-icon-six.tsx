  ...
  return (
    <>
      ...
      >
        <g
          id="Group_4196"
          data-name="Group 4196"
          transform="translate(-954 -1965)"
        >
          <rect
            id="Rectangle_577"
            ...
            height="38"
            rx="2"
            transform="translate(955 1996.398)"
            fill="#f1f5fe"
          />
          <g id="ecommerce" transform="translate(954 1965)">
            <g
              id="Group_4193"
              data-name="Group 4193"
              transform="translate(34.257 15.986)"
            >
              <path
                id="Path_8360"
                data-name="Path 8360"
                d="M30,14h9.135V24.277H30Z"
            ...
            <g
              ...
              transform="translate(45.675 13.703)"
            >
              <path
                id="Path_8361"
                data-name="Path 8361"
            ...
            >
              <path
                ...
                transform="translate(5.392 7.378)"
                fill="#ffb013"
              />
              <path
                id="Path_8363"
                ...
                transform="translate(4.257 7.378)"
                fill="#ffb013"
              />
              <path
                id="Path_8364"
                ...
                transform="translate(1.703 4.257)"
                fill="#ffb013"
              />
              <path
                id="Path_8365"
                data-name="Path 8365"
                d="M8,4h2.284V6.284H8Z"
                transform="translate(1.135 0.568)"
                fill="#091b4b"
              />
              <path
                id="Path_8366"
                data-name="Path 8366"
                d="M12,4h2.284V6.284H12Z"
                transform="translate(1.703 0.568)"
                fill="#091b4b"
              />
              <path
                id="Path_8367"
                data-name="Path 8367"
                d="M16,4h2.284V6.284H16Z"
                transform="translate(2.27 0.568)"
                fill="#091b4b"
              />
              <path
                id="Path_8368"
                data-name="Path 8368"
                d="M30,14h4.568v2.284H30Z"
                transform="translate(4.257 1.986)"
                fill="#091b4b"
              />
              <path
                id="Path_8369"
                data-name="Path 8369"
                d="M36,14h6.851v2.284H36Z"
                transform="translate(5.108 1.986)"
                fill="#091b4b"
              />
              <path
                id="Path_8370"
              ...
              <path
                ...
                transform="translate(6.527 2.554)"
                fill="#091b4b"
              />
              <path
                id="Path_8372"
                data-name="Path 8372"
                d="M30,18h9.135v2.284H30Z"
                transform="translate(4.257 2.554)"
                fill="#091b4b"
              />
              <path
                id="Path_8373"
                data-name="Path 8373"
                d="M30,22h9.135v2.284H30Z"
                transform="translate(4.257 3.121)"
                fill="#091b4b"
              />
            </g>
          </g>
...
export default FaqTopicIconSix;
